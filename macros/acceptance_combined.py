...
def main():
    # Optional analytical plot for acceptance in t
    plot_dt_acceptance()
    ...
    # 2) (Optional) if you want times only for a given s:
    # t_only = model.sample_t_for_s(s)  # [N,1]
